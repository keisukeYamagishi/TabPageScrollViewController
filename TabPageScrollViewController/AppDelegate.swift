...
//        let page:TabPageScrollViewController = TabPageScrollViewController()//st.instantiateInitialViewController() as! TabPageScrollViewController
//
////        let navigationController: UINavigationController = UINavigationController(rootViewController: TabPageScrollViewController())
////
//        let storyboard = UIStoryboard.init(name: "Main", bundle: nil)
////        let page:TabPageScrollViewController = navigationController.topViewController as! TabPageScrollViewController
//        page.delegate = self
...
//        self.window?.rootViewController = page//navigationController
